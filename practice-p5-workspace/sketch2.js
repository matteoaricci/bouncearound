...
levels.leveltwo.balls.forEach(ball => balls.push(ball))
levels.leveltwo.blocks.forEach(block => blocks.push(block))
levels.leveltwo.endPoint.forEach(end => endPoints.push(end))
let clickData = []
